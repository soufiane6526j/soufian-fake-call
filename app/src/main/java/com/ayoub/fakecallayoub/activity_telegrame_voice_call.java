...
public class activity_telegrame_voice_call extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        answerCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                findViewById(R.id.inf).setVisibility(View.VISIBLE);
                findViewById(R.id.lmnrt).setVisibility(View.GONE);
