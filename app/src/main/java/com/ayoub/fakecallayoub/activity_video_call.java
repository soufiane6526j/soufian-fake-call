...
public class activity_video_call extends AppCompatActivity implements SurfaceHolder.Callback{
    Camera camera;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_call);
         ...
         ImageView btnn=findViewById(R.id.endCallbtn);
         btnn.setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View view) {
                 AdsLoaded.loadaAdInter(activity_video_call.this);
    ...
    public void acceptVideoCall(View view) {
        ...
        findViewById(R.id.showa).setVisibility(View.VISIBLE);
        findViewById(R.id.ln1).setVisibility(View.GONE);
